...
<head>
    ...
    <link rel="icon" href="../admin/assets/image/logo.png">
    ...
    <header>
        <div class="container">
            <div class="logo">
                <a href="index.php">
                    <!-- <h3>JONGDENG NEWS</h3> -->
                    <img src="../admin/assets/Logo/<?php Getlogo('header'); ?>" alt="" width="100px" height="80px">
                </a>
            </div>
            <ul class="menu">
                ...
                <li class="menu-sport"><a href="javascript:viod(0)">ENTERTAINMENT</a>
                    <ul class="sub-menu sport">
                        <li>
                            <a href="Entertenmain-news-National.php">National</a>
                        </li>
                        <li>
                            <a href="Entertenmain-news-International.php">International</a>
                        </li>
                    </ul>
                </li>
